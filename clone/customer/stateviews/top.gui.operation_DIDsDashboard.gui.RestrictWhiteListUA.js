export const DIDsDashboardRestrictWhiteListUAState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "operationId": "UI_dids",
                    "heading": "Restrict White ListUA",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdIsRestrictWhiteListUA"],
                    ...
                    "TX_UpdIsRestrictWhiteListUA": {
                        ...
                        "operationId": "TX_UpdIsRestrictWhiteListUA",
                        "buttonLabel": "update",
                        "heading": "Restrict White ListUA",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                           // {"ViewParamId":57774, "name":"v_IsRestrictWhiteListUserAgent", "ctype":"select", "paramtype":"varchar", "label":"v_IsRestrictWhiteListUserAgent", "direction":"inout", "validator":"", "width":"auto"},
                            { "ViewParamId": 60465, "name": "v_IsRestrictWhiteListUserAgent", "ctype": "select", "paramtype": "ENUM", "label": "v_IsRestrictWhiteListUserAgent", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_IsRestrictWhiteListUserAgent", "ctype":"label", "paramtype":"varchar", "label":"v_IsRestrictWhiteListUserAgent", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.RestrictWhiteListUA.gui",
