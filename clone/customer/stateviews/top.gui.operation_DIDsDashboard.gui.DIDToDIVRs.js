export const DIDsDashboardDIDToDIVRsState = {
    states: [{
        name: "top.gui.operation_DIDsDashboard.gui.DIDToDIVRs",
        abstract: true,
        params: { reload: false },
        resolve: {
               ...
               "viewID": "9669",
                    ...
                    "gridOptions": {
                        ...
                        "columnDefs": [
                            ...
                            {"name":"v_CustomerIVRID", "type":"bigint", "default":null, "direction":"out"},
                            {"name":"v_StartTime", "type":"datetime", "default":null, "direction":"out"},
                            {"name":"v_EndTime", "type":"datetime", "default":null, "direction":"out"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.DIDToDIVRs.gui",
        url: "/DIDToDIVRs",
        views: {
            "tabContent@top": {
