export const DIDsDashboardDIDOutgoingBlockAddressState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
               "viewID": "9669",
                    "heading": "DID Outgoing Block Address",
                    "panelType": "ListView",
                    "operationId": "UI_dids",
                    "gridOptions": {
                        enableSorting: true,
                        ...
                        "columnDefs": [
                               ...
                               { "ViewColumnDefID": 36391, "name": "v_OutgoingBlockAddressPrefix","cellClass":"text-center", "label": "v_OutgoingBlockAddressPrefix", "width": "auto", enableCellEdit: true },
                 ...
                 "gridOperations": [{
                        ...
                        viewsObj: {
                            ...
                            "Params":[
                                {"ViewParamId":73336, "name":"v_OutgoingBlockAddressPrefix", "ctype":"textbox", "paramtype":"varchar", "label":"v_OutgoingBlockAddressPrefix", "direction":"in", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.DIDOutgoingBlockAddress.gui",
