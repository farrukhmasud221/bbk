export const resellersdashboardAccountcdrsState = {
    states: [{
        name: "top.gui.mediation_resellersdashboard.gui.accountcdrs",
        abstract: true,
        params: { reload: false },
        resolve: {
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.accountcdrs.gui",
        url: "/Accountcdrs",
        views: {
            "tabContent@top": {
                component: "formComponent"
            },
            "searchResult@top.gui.mediation_resellersdashboard.gui.accountcdrs.gui": {
