export const DIDsDashboardAccNoChargeHeadLineRentState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "operationId": "TX_UpdAccNoChargeHeadLineRentID",
                    "heading": "AccNo Charge HeadLine RentID",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdAccNoChargeHeadLineRentID"],
                    ...
                    "TX_UpdAccNoChargeHeadLineRentID": {
                        ...
                        "Params": [
                           ...
                           // {"ViewParamId":57774, "name":"v_AccNoChargeHeadLineRentID", "ctype":"select", "paramtype":"varchar", "label":"v_AccNoChargeHeadLineRentID", "direction":"inout", "validator":"", "width":"auto"},
                            { 

                                "ViewParamId": 72024, 
                                "name": "v_AccNoChargeHeadLineRentID", 
                                "ctype": "select", 
                               "paramtype": "ENUM", "label": "v_AccNoChargeHeadLineRentID", "direction": "inout", "validator": "", "options": [{ "display": "", "value": "" }, { "display": "", "value": "" }], "width":  "*"
                            },
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_AccNoChargeHeadLineRentID", "ctype":"label", "paramtype":"varchar", "label":"v_AccNoChargeHeadLineRentID", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.AccNoChargeHeadLineRent.gui",
