export const resellersdashboardGetAccountinfoState = {
    states: [{
        name: "top.gui.mediation_resellersdashboard.gui.getaccountinfo",
        abstract: true,
        params: {
            reload: true
        },
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.getaccountinfo.gui",
        url: "/GetAccountInfo",
        views: {
            "tabContent@top": { 
