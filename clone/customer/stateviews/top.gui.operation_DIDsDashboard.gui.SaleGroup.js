export const DIDsDashboardSaleGroupState = {
    states: [{
                ...
                let viewsObj = [{
                    ...
                    "LS_didsalegroups": {
                        ...
                        "Params": [
                            ...
                            //{"ViewParamId":57774, "name":"v_DIDSaleGroupID", "ctype":"select", "paramtype":"varchar", "label":"v_DIDSaleGroupID", "direction":"inout", "validator":"", "width":"auto"},
                          
                            { "ViewParamId": 60465, "name": "v_DIDSaleGroupID", "ctype": "select", "paramtype": "ENUM", "label": "v_DIDSaleGroupID", "direction": "inout", "validator": "", "options": [{ "display": "Default Sale", "value": "" },], "width": "auto" },
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.SaleGroup.gui",
        url: "/SaleGroup",
        views: {
