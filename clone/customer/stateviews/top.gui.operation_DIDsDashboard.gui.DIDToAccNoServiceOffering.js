export const DIDsDashboardDIDToAccNoServiceOfferingState = {
    states: [{
            ...
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "TX_AssignDIDToAccNoServiceOff": {
                        ...
                        "operationId": "TX_AssignDIDToAccNoServiceOff",
                        "buttonLabel": "update",
                        "heading": "RegionID",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            { "ViewParamId": 60465, "name": "v_AccNoServiceOfferingID", "ctype": "select", "paramtype": "ENUM", "label": "v_AccNoServiceOfferingID", "direction": "inout", "validator": "", "options": [{ "display": "", "value": "" }, { "display": "", "value": "" }], "width": "auto" },

                           // {"ViewParamId":57774, "name":"v_AccNoServiceOfferingID", "ctype":"select", "paramtype":"varchar", "label":"v_AccNoServiceOfferingID", "direction":"inout", "validator":"", "width":"auto"},
                            //{"ViewParamId":57774, "name":"v_SIPTrunkAssignmentDate", "ctype":"label", "paramtype":"varchar", "label":"v_SIPTrunkAssignmentDate", "direction":"inout", "validator":"", "width":"auto"},
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_AccNoServiceOfferingID", "ctype":"label", "paramtype":"varchar", "label":"v_AccNoServiceOfferingID", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.DIDToAccNoServiceOffering.gui",
