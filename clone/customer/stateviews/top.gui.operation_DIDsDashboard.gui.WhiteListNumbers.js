export const DIDsDashboardWhiteListNumbersState = {
    states: [{
               ...
               "viewID": "9669",
                    ...
                    "gridOptions": {
                        ...
                        enableRowHeaderSelection: false,
                         enableScrollbars: true,
                        exporterCsvFilename: 'WhiteListNumber.csv',
                        enableGridMenu: true,
                        ...
                        "columnDefs": [
                            ...
                            {"name":"v_DIDWhiteListNumber", "type":"varchar", "length":255, "default":null, "direction":"out"},
                 ...
                 "gridOperations": [{
                        operationId: "TX_UpdDIDIDWhiteList",
                        label: "Add",
                        type: "insert",
                        viewsObj: {
                            "viewID": "888",
                            ...
                            "operationId": "TX_UpdDIDIDWhiteList",
                            "Params":[
                                {"ViewParamId":73336, "name":"v_DIDWhiteListNumber", "ctype":"textbox", "paramtype":"varchar", "label":"v_DIDWhiteListNumber", "direction":"in", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.WhiteListNumbers.gui",
