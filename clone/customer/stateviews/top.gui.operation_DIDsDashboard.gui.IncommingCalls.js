export const DIDsDashboardIncommingCallsState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "operationId": "UI_dids",
                    "heading": "Ingoing call",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdIsIncomingAllowed"],
                    ...
                    "TX_UpdIsIncomingAllowed": {
                        ...
                        "operationId": "TX_UpdIsIncomingAllowed",
                        "buttonLabel": "update",
                        "heading": "Ingoing call",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [

                            { "ViewParamId": 60465, "name": "v_IsIncomingAllowed", "ctype": "select", "paramtype": "ENUM", "label": "v_IsIncomingAllowed", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },

                           
                          //  {"ViewParamId":57774, "name":"v_IsIncomingAllowed", "ctype":"select", "paramtype":"varchar", "label":"v_IsIncomingAllowed", "direction":"inout", "validator":"", "width":"auto"},
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_IsIncomingAllowed", "ctype":"label", "paramtype":"varchar", "label":"v_IsIncomingAllowed", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.IncommingCalls.gui",
        url: "/IncommingCalls",
        views: {
