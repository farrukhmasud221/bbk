export const DIDsDashboardRegionState = {
    states: [{
            ...
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "TX_UpdRegionID": {
                        ...
                        "operationId": "TX_UpdRegionID",
                        "buttonLabel": "update",
                        "heading": "RegionID",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            //{"ViewParamId":57774, "name":"v_RegionID", "ctype":"select", "paramtype":"varchar", "label":"v_RegionID", "direction":"inout", "validator":"", "width":"auto"},
                          
                            { "ViewParamId": 60465, "name": "v_RegionID", "ctype": "select", "paramtype": "ENUM", "label": "v_RegionID", "direction": "inout", "validator": "", "options": [{ "display": "", "value": "" }, { "display": "", "value": "" }], "width": "auto" },
                        ]
                    },
                    // "viewID": "1229",
                    // "heading": "Basic",
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.Region.gui",
        url: "/Region",
        views: {
