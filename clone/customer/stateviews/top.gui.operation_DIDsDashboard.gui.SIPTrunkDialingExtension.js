export const DIDsDashboardSIPTrunkDialingExtensionState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "operationId": "UI_dids",
                    "heading": "SIPTrunk Dialing Extension",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdSIPTrunkDialingExtension"],
                    ...
                    "TX_UpdSIPTrunkDialingExtension": {
                        ...
                        "operationId": "TX_UpdSIPTrunkDialingExtension",
                        "buttonLabel": "update",
                        "heading": "SIPTrunk Dialing Extension",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            {"ViewParamId":57774, "name":"v_SIPTrunkDialingExtension", "ctype":"label", "paramtype":"varchar", "label":"v_SIPTrunkDialingExtension", "direction":"inout", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.SIPTrunkDialingExtension.gui",
