export const DIDsDashboardProviderTrunkState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "updatePanel": [
                        ...
                        "TX_UpdDIDProviderTrunkID": {
                            ...
                            "operationId": "TX_UpdDIDProviderTrunkID",
                            "buttonLabel": "update",
                            "heading":"Provider Trunk",
                            "panelType": "UpdateableReadOnlyView",
                            "Params": [
                                { "ViewParamId": 60465, "name": "v_DIDID", "ctype": "select", "paramtype": "ENUM", "label": "v_DIDID", "direction": "inout", "validator": "", "options": [{ "display": "ST Trunk", "value": "" },], "width": "auto" },
                                //  { 

                                //     "ViewParamId": 72024, 
                                //     "name": "v_IsMasterSipTrunkDID", 
                                //     "ctype": "select", 
                                //    "paramtype": "ENUM", "label": "v_IsMasterSipTrunkDID", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width":  "*"
                                // },

                                
                               
                                
                                //{ "ViewParamId": 60465, "name": "v_IsMasterSipTrunkDID", "ctype": "select", "paramtype": "ENUM", "label": "v_IsMasterSipTrunkDID", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },
                                
                            ]
                        },
                //     "TX_UpdIsMasterSipTrunkDID": {
                //         "viewID": "3899",
                //         "mappings": {
                //             "v_DIDID": "DIDID"
                //         },
                //         "operationId": "TX_UpdIsMasterSipTrunkDID",
                //         "buttonLabel": "update",
                //         "heading": "Master Sip TrunkDID",
                //         "panelType": "UpdateableReadOnlyView",
                //         "Params": [
                //             { 
                //                 "ViewParamId": 72024, 
                ...
                //             },
                //  { "ViewParamId": 60465, "name": "v_IsMasterSipTrunkDID", "ctype": "select", "paramtype": "ENUM", "label": "v_IsMasterSipTrunkDID", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },        
                // //{"ViewParamId":57774, "name":"v_IsMasterSipTrunkDID", "ctype":"select", "paramtype":"varchar", "label":"v_IsMasterSipTrunkDID", "direction":"inout", "validator":"", "width":"auto"},
                ...
                //     },
                    ...
                    // "heading": "Basic",
                    // "panelType": "ReadOnlyView",
                    // "operationId": "UI_didsByDIDNumber",
                    // "mappings": {
                    //     "v_DIDID": "DIDID"
                    // },
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_IsMasterSipTrunkDID", "ctype":"label", "paramtype":"varchar", "label":"v_IsMasterSipTrunkDID", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.ProviderTrunk.gui",
        url: "/ProviderTrunk",
        views: {
