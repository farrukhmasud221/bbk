export const DIDsDashboardDIDIncomingBlockAddressesState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
               "viewID": "9669",
                    "heading": "DID Incoming Block Addresses",
                    "panelType": "ListView",
                    "operationId": "UI_dids",
                    "gridOptions": {
                        enableSorting: true,
                        ...
                        "columnDefs": [
                               ...
                               { "ViewColumnDefID": 36391, "name": "v_IncomingBlockAddressPrefix","cellClass":"text-center", "label": "v_IncomingBlockAddressPrefix", "width": "auto", enableCellEdit: true },
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.DIDIncomingBlockAddresses.gui",
