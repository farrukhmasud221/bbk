export const ABMFDashboardLifeCycleState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "heading": "Change Subscriber State ",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    ...
                    "UI_statestimuli": {
                        ...
                        "operationId": "UI_statestimuli",
                        "buttonLabel": "update",
                        "heading": "Change Subscriber State",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            {"ViewParamId":57774, "name":"v_StateStimulusID", "ctype":"select", "paramtype":"varchar", "label":"v_StateStimulusID", "direction":"inout", "validator":"", "width":"auto"},


                            { 

                                "ViewParamId": 72024, 
                                "name": "v_SubscriberStateName", 
                                "ctype": "select", 
                               "paramtype": "ENUM", "label": "v_SubscriberStateName", "direction": "inout", "validator": "", "options": [{ "display": "Active", "value": "Active" }, { "display": "Voluntary", "value": "Voluntary" }], "width":  "*"
                            },
                           // {"ViewParamId":57774, "name":"v_SubscriberStateName", "ctype":"select", "paramtype":"varchar", "label":"v_SubscriberStateName", "direction":"inout", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_ABMFDashboard.gui.LifeCycle.gui",
        url: "/LifeCycle",
        views: {
