export const DIDsDashboardWhiteListUserAgentsState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
               "viewID": "9669",
                    "heading": "White List User Agents",
                    "panelType": "ListView",
                    "operationId": "UI_dids",
                    "gridOptions": {
                        enableSorting: true,
                        ...
                        "columnDefs": [
                            ...
                            {"name":"v_SIPUserAgentID", "type":"bigint", "default":null, "direction":"out"},
                 ...
                 "gridOperations": [{
                        operationId: "TX_Insdidwhitelistuseragent",
                        label: "Add",
                        type: "insert",
                        viewsObj: {
                            "viewID": "888",
                            ...
                            "operationId": "TX_Insdidwhitelistuseragent",
                            "Params":[
                                {"ViewParamId":73336, "name":"v_SIPUserAgentID", "ctype":"textbox", "paramtype":"varchar", "label":"v_SIPUserAgentID", "direction":"in", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.WhiteListUserAgents.gui",
