export const resellersdashboardChangePasswordState = {
    states: [{
        name: "top.gui.mediation_resellersdashboard.gui.ChangePassword",
        abstract: true,
        params: {
            reload: true
        },
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.ChangePassword.gui",
        url: "/ChangePassword",
        views: {
            "tabContent@top": {
