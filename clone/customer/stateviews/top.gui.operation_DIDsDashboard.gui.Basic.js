export const DIDsDashboardBasicState = {
    states: [{
                ...
                let viewsObj = [{
                    ...
                    "TX_UpdDIDSIPTrunkID": {
                        ...
                        "Params": [
                            ...
                            {"ViewParamId":57773, "name":"v_DIDID", "ctype":"label", "paramtype":"varchar", "label":"v_DIDID", "direction":"out", "validator":"", "width":"auto"},
                           // {"name":"v_DIDID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_ID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_DIDNumber", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_AgentID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_CityID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_AreaCodeID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_DIDPurchaseGroupID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_DIDSaleGroupID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_DIDProviderTrunkID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_SIPTrunkID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_SIPTrunkDialingExtension", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_SIPTrunkExtDialingGroupID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_IsMasterSipTrunkDID", "type":"tinyint", "default":null, "direction":"out"},
					{"name":"v_SIPTrunkAssignmentDate", "type":"datetime", "default":null, "direction":"out"},
					{"name":"v_AccNoServiceOfferingID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_AccNoChargeHeadLineRentID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_Status", "type":"tinyint", "default":null, "direction":"out"},
					{"name":"v_AccountID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_AssignedDate", "type":"datetime", "default":null, "direction":"out"},
					{"name":"v_ServiceID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_HuntGroupID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_Username", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_DomainName", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_LiveStatus", "type":"enum", "length":12, "default":null, "direction":"out"},
					{"name":"v_RegistrationDate", "type":"datetime", "default":null, "direction":"out"},
					{"name":"v_DIDType", "type":"enum", "length":16, "default":null, "direction":"out"},
					{"name":"v_RegionID", "type":"bigint", "default":null, "direction":"out"},
					{"name":"v_IsIncomingAllowed", "type":"tinyint", "default":null, "direction":"out"},
					{"name":"v_IsOutgoingAllowed", "type":"tinyint", "default":null, "direction":"out"},
					{"name":"v_IsRestrictWhiteListUserAgent", "type":"tinyint", "default":null, "direction":"out"},
					{"name":"v_IncomingTechPrefix", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_IncomingCLIRuleName", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_IncomingCLIRuleData1", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_OutgoingCLIRuleName", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_OutgoingCLIRuleData1", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_PopName", "type":"varchar", "length":255, "default":null, "direction":"out"},
					{"name":"v_ForwardingNumber", "type":"varchar", "length":255, "default":null, "direction":"out"}
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.Basic.gui",
        url: "/Basic",
        views: {
