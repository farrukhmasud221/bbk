export const mediationOperationLS_SpecialNumbersState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    "viewID": "1180",
                    "heading": "Special Numbers",
                    "panelType": "ListView",
                    "operationId": "LS_specialnumbers",
                    "gridOptions": {
                        enableSorting: true,
                        ...
                        "columnDefs": [
                            ...
                            { "ViewColumnDefID": 36396, "name": "v_CallingPrefix","cellClass":"text-center", "label": "v_CallingPrefix", "width": "*", enableCellEdit: false },
                            ...
                            { "ViewColumnDefID": 36396, "name": "v_SpecialNumberID","cellClass":"text-center", "label": "v_SpecialNumberID", "width": "*", enableCellEdit: false },
    ...
    {
        name: "top.gui.mediation_operation_LS_SpecialNumbers.gui",
        url: "SpecialNumbers",
        views: {
            "tabContent@top": {
