export const dashboard = {
    states: [{
        name: "top.gui.mediation.dashboard",
        abstract: true,
        params: { reload: false },
        resolve: {
                ...
                let viewsObj = [{
                    ...
                    "gridOptions": {
                        ...
                        "columnDefs": [
                            ...
                            { "name": "v_DeviceVersion", "label": "v_DeviceVersion", "width": "*", enableCellEdit: false },
                            // { "name": "v_DeviceVersionChangeCount", "label": "v_DeviceVersionChangeCount", "width": "*", enableCellEdit: false },
                            { "name": "v_LastFailedVoucherAttempt", "label": "v_LastFailedVoucherAttempt", "width": "*", enableCellEdit: false },
                            ...
                            // { "name": "v_NoOfFailedVoucherRecharges", "label": "v_NoOfFailedVoucherRecharges", "width": "*", enableCellEdit: false },
                             { "name": "v_NoOfIdentificationAttempts", "label": "v_NoOfIdentificationAttempts", "width": "*", enableCellEdit: false },
                        ],
                    },
                    // "gridOperations": [{
    ...
    {
        name: "top.gui.mediation.dashboard.gui",
        url: "dashboard",
        views: {
            "tabContent@top": {
