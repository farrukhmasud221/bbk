export const MediaCodecDashboardConcurrentSessionsState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "heading": "Concurrent Sessions",
                    "mappings": {
                        "v_MediaCodecID": "MediaCodecID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdMaxConcurrentSessions"],
                    ...
                    "TX_UpdMaxConcurrentSessions": {
                        ...
                        "operationId": "TX_UpdMaxConcurrentSessions",
                        "buttonLabel": "update",
                        "heading": "Concurrent Sessions",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            {"ViewParamId":57774, "name":"v_MaxConcurrentSessions", "ctype":"label", "paramtype":"varchar", "label":"v_MaxConcurrentSessions", "direction":"inout", "validator":"", "width":"auto"},
                   ...
                   // "Params":[
                      ...
                      //  {"ViewParamId":57791, "name":"v_MaxConcurrentSessions", "ctype":"label", "paramtype":"varchar", "label":"v_MaxConcurrentSessions", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_MediaCodecDashboard.gui.ConcurrentSessions.gui",
