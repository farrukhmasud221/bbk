export const MediaCodecDashboardCodecPriorityState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                ...
                "TX_UpdMediaCodecPriority": {
                    ...
                    "operationId": "TX_UpdMediaCodecPriority",
                    "buttonLabel": "update",
                    "heading": "Media Codecs Priority",
                    "panelType": "UpdateableReadOnlyView",
                    "Params": [
                       
    {"ViewParamId":57774, "name":"v_MediaCodecID", "ctype":"label", "paramtype":"varchar", 
    "label":"v_MediaCodecID", "direction":"inout", "validator":"", "width":"auto"},
    {"ViewParamId":57774, "name":"v_MediaCodecPriority", "ctype":"label", "paramtype":"varchar", 
    "label":"v_MediaCodecPriority", "direction":"inout", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_MediaCodecDashboard.gui.CodecPriority.gui",
        url: "/CodecPriority",
        views: {
