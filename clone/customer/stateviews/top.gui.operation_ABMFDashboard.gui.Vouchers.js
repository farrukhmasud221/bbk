export const ABMFDashboardVouchersState = {
    states: [{
            ...
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "TX_RedeemVoucher": {
                        ...
                        "operationId": "TX_RedeemVoucher",
                        "buttonLabel": "update",
                        "heading": "Vouchers",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            {"name":"v_PIN", "type":"varchar", "length":255, "default":null, "direction":"inout"},
    ...
    {
        name: "top.gui.operation_ABMFDashboard.gui.Vouchers.gui",
        url: "/Vouchers",
        views: {
