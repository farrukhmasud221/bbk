export const resellersdashboardPaymentByVoucherState = {
    states: [{
        name: "top.gui.mediation_resellersdashboard.gui.paymentbyvoucher",
        abstract: true,
        params: {
            reload: true
        },
		    ...
		    "buttonLabel": "Add payment",
                    ...
                    "WF_PaymentByVoucher":{
                        ...
                        "Params":[
                            ...
                            //{"ViewParamId":61575, "name":"v_PublicIdentity", "ctype":"readonly", "paramtype":"bigint", "label":"v_AccNoprivateIdentityID", "direction":"in", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.paymentbyvoucher.gui",
