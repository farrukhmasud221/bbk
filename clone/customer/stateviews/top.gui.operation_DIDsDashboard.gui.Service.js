export const DIDsDashboardServiceState = {
    states: [{
                ...
                let viewsObj = [{
                    ...
                    "updatePanel": [
                        ...
                        "TX_UpdServiceID": {
                            ...
                            "operationId": "TX_UpdServiceID",
                            "buttonLabel": "update",
                            "heading":"Service",
                            "panelType": "UpdateableReadOnlyView",
                            "Params": [
                               // { "ViewParamId": 60465, "name": "v_DIDID", "ctype": "readonly", "paramtype": "ENUM", "label": "v_DIDID", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },
                                 { 

                                    "ViewParamId": 72024, 
                                    "name": "v_ServiceID", 
                                    "ctype": "select", 
                                   "paramtype": "ENUM", "label": "v_ServiceID", "direction": "inout", "validator": "", "options": [{ "display": "Default Service", "value": "1" }, { "display": "SIP trunking", "value": "100001" }], "width":  "*"
                                },
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.Service.gui",
        url: "/Service",
        views: {
