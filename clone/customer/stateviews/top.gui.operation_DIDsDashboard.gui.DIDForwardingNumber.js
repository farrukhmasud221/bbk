export const DIDsDashboardDIDForwardingNumberState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "heading": "DID Forwarding Number",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdDIDForwardingNumber"],
                    ...
                    "TX_UpdDIDForwardingNumber": {
                        ...
                        "Params": [
                            ...
                            {"ViewParamId":57774, "name":"v_ForwardingNumber", "ctype":"label", "paramtype":"varchar", "label":"v_ForwardingNumber", "direction":"inout", "validator":"", "width":"auto"},
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"C", "ctype":"label", "paramtype":"varchar", "label":"v_ForwardingNumber", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.DIDForwardingNumber.gui",
