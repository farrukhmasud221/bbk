export const resellersdashboardgetresellersRegistrationStatus = {
    
    states: [{
        
        name: "top.gui.mediation_resellersdashboard.gui.getresellersRegistrationStatus",
        abstract: true,
        params: {
            reload: true
        },
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.getresellersRegistrationStatus.gui",
