export const DIDsDashboardIncommingTechPrefixState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "operationId": "UI_dids",
                    "heading": "Incoming Tech Prefix",
                    "mappings": {
                        "v_DIDID": "DIDID"
                    },
                    "panelType": "ReadOnlyView",
                    "updatePanel": [
                        "TX_UpdIncomingTechPrefix"],
                    ...
                    "TX_UpdIncomingTechPrefix": {
                        ...
                        "operationId": "TX_UpdIncomingTechPrefix",
                        "buttonLabel": "update",
                        "heading": "Incoming Tech Prefix",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            {"ViewParamId":57774, "name":"v_IncomingTechPrefix", "ctype":"label", "paramtype":"varchar", "label":"v_IncomingTechPrefix", "direction":"inout", "validator":"", "width":"auto"},
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_IncomingTechPrefix", "ctype":"label", "paramtype":"varchar", "label":"v_IncomingTechPrefix", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.IncommingTechPrefix.gui",
