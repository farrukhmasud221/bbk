export const privateIdentityDashboardAccountCreditState = {
    states: [{
                ...
                let viewsObj = [{
                    ...
                    "WF_AccountCredit": {
                        ...
                        "Params": [
                            ...
                            { "ViewParamId": 72024, "name": "balance", "ctype": "readonly", "paramtype": "varchar", "label": "Account Balance", "direction": "inout", "validator": "", "width": "*" },
    ...
    {
        name: "top.gui.mediation_privateidentitydashboard.gui.AccountCredit.gui",
        url: "/AccountCredit",
        views: {
            "tabContent@top": {
