export const privateIdentityDashboardRegistrarSettingsState = {
    states: [{
        ...
        resolve: {
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
			   ...
			   // { "ViewParamId": 72025, "name": "Note", "ctype": "hidden", "paramtype": "varchar", "direction": "inout", "validator": "", "width": "*" },
    ...
    {
        name: "top.gui.mediation_privateidentitydashboard.gui.registrarsettings.gui",
