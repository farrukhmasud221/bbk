export const resellerdashboardBasicInformationState = {
    states: [{
        name: "top.gui.mediation_resellerdashboard.gui.basicinformation",
        abstract: true,
        params: {
            reload: true
        },
    ...
    {
        name: "top.gui.mediation_resellerdashboard.gui.basicinformation.gui",
