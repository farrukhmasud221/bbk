export const resellersdashboardgetPaymentsList = {
    states: [{
        name: "top.gui.mediation_resellersdashboard.gui.getPaymentsList",
        abstract: true,
        resolve: {
    ...
    {
        name: "top.gui.mediation_resellersdashboard.gui.getPaymentsList.gui",
        url: "/getPaymentsList",
        views: {
