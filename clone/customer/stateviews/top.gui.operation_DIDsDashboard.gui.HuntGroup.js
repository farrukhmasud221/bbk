export const DIDsDashboardHuntGroupState = {
    states: [{
            ...
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "TX_UpdHuntGroupID": {
                        ...
                        "operationId": "TX_UpdHuntGroupID",
                        "buttonLabel": "update",
                        "heading": "Hunt GroupID",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                            //{"ViewParamId":57774, "name":"v_HuntGroupID", "ctype":"select", "paramtype":"varchar", "label":"v_HuntGroupID", "direction":"inout", "validator":"", "width":"auto"},
                            { "ViewParamId": 60465, "name": "v_HuntGroupID", "ctype": "select", "paramtype": "ENUM", "label": "v_HuntGroupID", "direction": "inout", "validator": "", "options": [{ "display": "", "value": "" }, { "display": "", "value": "" }], "width": "auto" },
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_HuntGroupID", "ctype":"label", "paramtype":"varchar", "label":"v_HuntGroupID", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.HuntGroup.gui",
        url: "/HuntGroup",
        views: {
