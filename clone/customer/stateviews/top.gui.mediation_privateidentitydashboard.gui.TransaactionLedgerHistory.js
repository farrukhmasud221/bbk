export const privateIdentityDashboardTransaactionLedgerHistoryState = {
    states: [{
        name: "top.gui.mediation_privateidentitydashboard.gui.TransaactionLedgerHistory",
       abstract: true,
        resolve: {
                ...
                let viewsObj = [
                    ...
                    "gridOptions": {
                        ...
                        "columnDefs": [
                           ...
                           // { "ViewColumnDefID": 36391, "name": "Balance","cellClass":"text-center", "label": "Balance",  "width": "auto", enableCellEdit: false },
    ...
    {
        name: "top.gui.mediation_privateidentitydashboard.gui.TransaactionLedgerHistory.gui",
        url: "/TransaactionLedgerHistory",
        views: {
            "tabContent@top": {
