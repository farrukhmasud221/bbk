export const DIDsDashboardOutgoingCallsState = {
    states: [{
            ...
            viewsObj: ["metaDataService", "$stateParams", async function (metaDataService, $stateParams) {
                let viewsObj = [{
                    ...
                    "TX_UpdIsOutgoingAllowed": {
                        ...
                        "operationId": "TX_UpdIsOutgoingAllowed",
                        "buttonLabel": "update",
                        "heading": "Outgoing call",
                        "panelType": "UpdateableReadOnlyView",
                        "Params": [
                           
                           // {"ViewParamId":57774, "name":"v_IsOutgoingAllowed", "ctype":"select", "paramtype":"varchar", "label":"v_IsOutgoingAllowed", "direction":"inout", "validator":"", "width":"auto"},
                            ...
                            { "ViewParamId": 60465, "name": "v_IsOutgoingAllowed", "ctype": "select", "paramtype": "ENUM", "label": "v_IsOutgoingAllowed", "direction": "inout", "validator": "", "options": [{ "display": "Yes", "value": "1" }, { "display": "No", "value": "0" }], "width": "auto" },
                    ...
                    // "Params":[
                    //      {"ViewParamId":57773, "name":"v_IsOutgoingAllowed", "ctype":"label", "paramtype":"varchar", "label":"v_IsOutgoingAllowed", "direction":"out", "validator":"", "width":"auto"},
    ...
    {
        name: "top.gui.operation_DIDsDashboard.gui.OutgoingCalls.gui",
        url: "/OutgoingCalls",
        views: {
